        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse " id="navbarNavAltMarkup">
              <div class="navbar-nav ml-auto">
                ...
                <a class="nav-item nav-link d-inline-block ml-2 active" href="{{url('/siswa')}}">siswa</a>
                <a class="nav-item nav-link d-inline-block ml-2 active" href="{{url('/jurusan')}}">Jurusan</a>
              </div>
            </div>
        </div>
    </nav>
